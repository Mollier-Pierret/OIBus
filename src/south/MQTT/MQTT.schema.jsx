...
schema.form = {
  ...
  bufferMax: {
    ...
    help: 'The number of values the buffer must reach before caching values',
    valid: minValue(0),
    defaultValue: 250,
  },
  bufferTimeoutInterval: {
    type: 'OIbInteger',
    newRow: false,
    label: 'Buffer flush interval',
    help: 'The number of ms before flushing the buffer to cache its values',
    valid: minValue(10),
    defaultValue: 300,
  },
}
